 ...
 * Data are provided in name / value pairs (like a Dictionary in Swift)
 ...
 * Square brackets hold arrays (an array is a list of related objects)
 ...
 The indents, or extra spaces, have no meaning – they just make the JSON easier for humans to read.
